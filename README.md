...
Create **React** JSON parser (without external library!) that will pretty out given JSON. You can either make version with **form** or **hook it up to the API** (https://jsonplaceholder.typicode.com/users). Make sure to document the project well!
